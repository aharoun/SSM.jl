...
# aSim = arima([0.6, -0.3, 0.1], [0.2], 0.1, 0)
...
# we can also directly cast a generic state space model by defining state space matrices and estimate it
# s = StateSpace(A, B, G, R, H, S)
# sEst, res, std = estimate(s, y);
